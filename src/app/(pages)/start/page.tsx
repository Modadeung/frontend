...
import onon from "@/assets/images/onon.png";
...
export default function StartPage() {
  ...
  return (
    <>
      ...
      {isLoading && (
        <div
          className={`absolute mx-auto w-390 h-844 inset-0 flex items-center justify-center overflow-hidden ${
            slideUp ? "slide-up" : ""
          }`}
        >
          <Image src={onon} alt="onboarding" fill className="object-fill" />
        </div>
      )}
    </>
  );
